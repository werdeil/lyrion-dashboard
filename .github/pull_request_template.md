...
- [ ] `README.md` and `README.fr.md` kept in lockstep if user-facing behaviour changed, and any `.claude/skills/` page describing what this PR changed updated with it

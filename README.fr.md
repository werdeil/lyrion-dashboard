...
- **Recherche web de paroles** -- Un interrupteur de recherche automatique interroge le web (LRCLIB, Musixmatch, Genius) pour chaque morceau joué : il complète les paroles absentes de la bibliothèque et convertit son texte simple en version synchronisée (karaoké) lorsqu'il en trouve une. Tant qu'il est activé, un bouton permet de relancer la recherche pour le morceau en cours, en contournant le cache.

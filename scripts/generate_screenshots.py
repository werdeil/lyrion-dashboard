...
def _stats():
    s = {
        ...
        "songs_played_once": 3961, "songs_played_2_4": 3742, "songs_played_5_plus": 1227,
    ...
    for key in ("songs_played_once", "songs_played_2_4", "songs_played_5_plus"):
        s[key + "_pct"] = _pct(s[key], s["songs_total"])
    return s
